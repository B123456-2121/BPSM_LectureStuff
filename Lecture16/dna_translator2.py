...
# no real builtin reverse method, reversed() produces a
# different kind of object that we dont really want to deal with!
# the following method is a slice [::-1],
# is very fast, also regenerates as a string, which is what we want!
       rc_dna = c_dna[::-1]       
       print("Was\n",dna,"\nnow\n",rc_dna)
       dna = rc_dna
